...
<img src="./src/assets/background_section_7.png" alt='dd' className=" absolute -bottom-12 right-0 sm:right-20  md:right-32  z-0 w-96 "/> 
      <div className="absolute bg-[#41374f] opacity-80 inset-0 z-10 "></div>
      <div className="  mr-15 ml-96 z-20 ">
